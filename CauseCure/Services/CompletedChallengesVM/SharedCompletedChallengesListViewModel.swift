//
//  SharedCompletedChallengesVM.swift
//  CauseCure
//
...
class SharedCompletedChallengeCellViewModel: ObservableObject, Identifiable {
    @Published var repository : Repository
    
    @Published var completedChallenge: SharedCompletedChallenge
    ...
    init(completedChallenge: SharedCompletedChallenge, repository: Repository) {
